{strip}
  ...
  <script>
    ...
    __['Write a message'] = `{__('Write a message')}`;
  ...
  {if $user->_logged_in}
    ...
    <!-- TinyMCE -->
    {if $user->_data['can_add_rich_text_posts'] || in_array($page, ["admin", "blogs", "forums", "support"])}
    ...
    {if in_array($page, ["admin", "ads", "wallet", "developers", "settings", "page", "group"])}
      <link href="https://cdn.datatables.net/v/bs5/dt-3.0.2/datatables.min.css" rel="stylesheet" integrity="sha384-WF7rwYENOlMDvld6NrDCybYx4zw25V2G1g3yQABr10/zSiPSew1KJZw0/oWSTAPC" crossorigin="anonymous" defer>
      <script src="https://cdn.datatables.net/v/bs5/dt-3.0.2/datatables.min.js" integrity="sha384-3OH5YkC3CJnoBt0Y3tl90xrsmjoUNknIyLLhWLZ/1/7ZgpXcbhebGu0PWn0h+df0" crossorigin="anonymous" defer></script>
    {/if}
    <!-- Datatables -->
  ...
  {if $user->_logged_in}
    ...
    {if $licence_monetization && is_file('includes/assets/js/core/payments.js')}
      <script src="{$system['system_url']}/includes/assets/js/core/payments.js?v={$system['system_version']}-{filemtime('includes/assets/js/core/payments.js')}"></script>
    {/if}
