...
<!-- Panic Mode -->
{if $user->_logged_in && $system['panic_mode_enabled']}
  <div id="panic-mode-content">
    <div class="container">
      <img class="img-fluid" src="{$system['system_url']}/content/themes/{$system['theme']}/images/panic-mode.png" alt="">
    </div>
  </div>
  <button id="panic-mode-toggle" class="btn rounded-circle">
    {include file='__svg_icons.tpl' icon="panic" class="main-icon" width="20px" height="20px"}
  </button>
{/if}
<!-- Panic Mode -->
