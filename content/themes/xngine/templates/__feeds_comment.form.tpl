	...
	<div class="d-flex x_user_info gap-2">
		...
		<div class="comment-data flex-1">
			<div class="x-form comment-form d-flex align-items-end gap-2">
				<textarea dir="auto" class="js_autosize js_mentions js_post-comment bg-transparent px-0 w-100 m-0 py-2 border-0" rows="1" placeholder='{__("Write a comment")}'></textarea>
