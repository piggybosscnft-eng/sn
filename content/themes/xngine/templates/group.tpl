				...
				{else}
					...
					{if $system['blogs_enabled']}
						<div {if $view == "blogs"}class="active fw-semibold" {/if}>
							<a href="{$system['system_url']}/groups/{$group['group_name']}/blogs" class="body-color side_item_hover w-100 text-center d-block">
				...
				<div class="col-lg-4 px-lg-3 py-3 order-2 js_sticky-sidebar">
					...
					{if $user->_logged_in && !$group['i_admin'] && $group['has_subscriptions_plans']}
						<button class="btn btn-primary mb-3 w-100" data-toggle="modal" data-url="monetization/controller.php?do=get_plans&node_id={$group['group_id']}&node_type=group" data-size="large">
							{__("SUBSCRIBE FOR")} {if $group['group_monetization_discount_enabled']}{print_money($group['group_monetization_min_price'] * (1 - $group['group_monetization_discount_percent'] / 100))}{/if}{if $group['group_monetization_discount_enabled']}<span class="ms-1 text-decoration-line-through">{/if}{print_money($group['group_monetization_min_price'])}{if $group['group_monetization_discount_enabled']}</span>{/if}
						</button>
					{/if}
					<!-- subscribe -->
						...
						<div class="x_menu_sidebar_content flex-1">
							...
							{elseif $sub_view == "monetization"}
								<div class="p-3 w-100">
									...
									{if $show == "coupons"}
										<button data-toggle="modal" data-url="monetization/controller.php?do=add_coupon&node_id={$group['group_id']}&node_type=group" class="btn btn-sm mt-2 btn-primary">
								...
								<div class="p-3 pt-1">
									{if $show == "settings"}
										...
										<form class="js_ajax-forms" data-url="modules/create.php?type=group&do=edit&edit=monetization&id={$group['group_id']}">
											...
											<div class="form-floating">
												<input type="number" min="1" max="99" class="form-control" name="group_monetization_discount_percent" value="{$spage['group_monetization_discount_percent']}" placeholder=" ">
											...
											<div class="row payment-plans">
												<div class="col-md-6 mb-4">
													<div data-toggle="modal" data-url="monetization/controller.php?do=add_plan&node_id={$group['group_id']}&node_type=group" class="payment-plan new h-100 x_adslist pointer p-3">
