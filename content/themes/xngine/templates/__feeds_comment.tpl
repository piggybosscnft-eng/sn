						...
						{if $user->_logged_in}
							<div class="x-hidden mt-2 pt-1 js_reply-form">
								<div class="x-form comment-form d-flex align-items-end gap-2">
									<textarea dir="auto" class="js_autosize js_mentions js_post-reply bg-transparent px-0 w-100 m-0 py-2 border-0" rows="1" placeholder='{__("Write a Reply")}'></textarea>
