    ...
    <div class="col-lg-12 w-100">
		<div class="d-flex align-items-center p-3 position-sticky x_top_posts">
			<div class="d-flex align-items-center justify-content-between gap-10 position-relative">
				<span class="headline-font fw-semibold side_widget_title p-0 flex-0">{__("Watch")}</span>
		...
		<div class="pt-3 pb-2 px-2 mx-1">
			<form class="js_search-form" data-filter="posts" data-type="video">
				<div class="position-relative">
					<input type="search" class="form-control shadow-none rounded-pill x_search_filter" name="query" placeholder='{__("Search for videos")}'>
				...
				<ul class="px-3 d-flex gap-2 align-items-center overflow-x-auto pb-3 scrolll">
					...
					{else}
						{if $current_category['parent']}
							<li>
								<a class="btn btn-sm border-0 ps-0 pe-1" href="{$system['system_url']}/watch/category/{$current_category['parent']['category_id']}/{$current_category['parent']['category_url']}">
						...
						{else}
							<li>
								<a class="btn btn-sm border-0 ps-0 pe-1" href="{$system['system_url']}/watch">
					...
					{foreach $categories as $category}
						<li {if $view == "category" && $current_category['category_id'] == $category['category_id']}class="position-relative main main_bg_half" {/if}>
							<a class="btn btn-sm" href="{$system['system_url']}/watch/category/{$category['category_id']}/{$category['category_url']}">
