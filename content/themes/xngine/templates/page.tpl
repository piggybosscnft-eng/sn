			...
			<div class="d-flex align-items-center justify-content-center">
				...
				{if $system['blogs_enabled']}
					<div {if $view == "blogs"}class="active fw-semibold" {/if}>
						<a href="{$system['system_url']}/pages/{$spage['page_name']}/blogs" class="body-color side_item_hover w-100 text-center d-block">
							<span class="position-relative d-inline-block py-3">{__("Blogs")}</span>
						</a>
					</div>
				{/if}
				{if $spage['market_enabled']}
				...
				<div class="col-lg-4 px-lg-3 py-3 order-2 js_sticky-sidebar">
					...
					{if $user->_logged_in && !$spage['i_admin'] && $spage['has_subscriptions_plans']}
						<button class="btn btn-primary w-100 mb-3" data-toggle="modal" data-url="monetization/controller.php?do=get_plans&node_id={$spage['page_id']}&node_type=page" data-size="large">
							{__("SUBSCRIBE FOR")} {if $spage['page_monetization_discount_enabled']}{print_money($spage['page_monetization_min_price'] * (1 - $spage['page_monetization_discount_percent'] / 100))}{/if}{if $spage['page_monetization_discount_enabled']}<span class="ms-1 text-decoration-line-through">{/if}{print_money($spage['page_monetization_min_price'])}{if $spage['page_monetization_discount_enabled']}</span>{/if}
						</button>
					{/if}
					<!-- subscribe -->
					...
					<div class="w-100 d-flex bg-white no_hide_settings">
							...
							<ul class="side-nav x_settings pb-3">
								...
								{if $user->_data['can_monetize_content']}
									<li {if $sub_view == "monetization" && $show == "settings"}class="active" {/if}>
										<a href="#monetization-settings" class="main_bg_half position-relative" data-bs-toggle="collapse" {if $sub_view == "monetization"}aria-expanded="true" {/if}>
											{__("Monetization")}
										</a>
						...
						<div class="x_menu_sidebar_content flex-1">
							...
							{elseif $sub_view == "monetization"}
								<div class="p-3 w-100">
									<div class="headline-font fw-semibold side_widget_title p-0">
										{__("Monetization")} {if $show == "coupons"} &rsaquo; {__("Coupons")}{/if}
									</div>

									{if $show == "coupons"}
										<button data-toggle="modal" data-url="monetization/controller.php?do=add_coupon&node_id={$spage['page_id']}&node_type=page" class="btn btn-sm mt-2 btn-primary">
								...
								<div class="p-3 pt-1">
									{if $show == "settings"}
										...
										<form class="js_ajax-forms" data-url="modules/create.php?type=page&do=edit&edit=monetization&id={$spage['page_id']}">
											...
											<div class="form-floating">
												<input type="number" min="1" max="99" class="form-control" name="page_monetization_discount_percent" value="{$spage['page_monetization_discount_percent']}" placeholder=" ">
											...
											<div class="row payment-plans">
												<div class="col-md-6 mb-4">
													<div data-toggle="modal" data-url="monetization/controller.php?do=add_plan&node_id={$spage['page_id']}&node_type=page" class="payment-plan new h-100 x_adslist pointer p-3">
