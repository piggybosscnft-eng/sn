				...
				<div class="position-relative bg-white p-3 blog {if ($blog['is_pending']) OR ($blog['in_group'] && !$blog['group_approved']) OR ($blog['in_event'] && !$blog['event_approved'])}pending{/if}" data-id="{$blog['post_id']}">
					...
					<div class="blog-wrapper">
						...
						{if $blog['is_collaborative']}
							<div class="collaborative-users mt-3">
						...
						{if $blog['blog']['references']}
							<section class="blog-references-section mb-3" aria-labelledby="blog-references-title">
				...
				<div id="blog-references-list">
					{foreach $blog['blog']['references'] as $key => $reference}
						<div class="auto-connect-node p-3">
							...
							<div class="form-floating">
								<input type="text" class="form-control" name="references[{$key}][title]" value="{$reference['title']}" placeholder=" ">
								<label class="form-label">{__('Title')}</label>
							</div>
							<div class="form-floating mb-0">
								<input type="text" class="form-control" name="references[{$key}][link]" value="{$reference['link']}" placeholder=" ">
    ...
    {elseif $view == "new"}
		...
		<div class="col-lg-8">
			...
			{if $system['ai_posts_enabled']}
                <div class="px-3 pt-2">
					<button type="button" class="btn btn-primary" data-toggle="modal" data-size="large" data-url="ai/modal.php?handle=blog">
						{__("Generate with AI")}
					</button>
				</div>
            {/if}
			...
			<div class="js_ajax-forms-html p-3" data-url="posts/blog.php?do=create">
				...
				<div class="form-floating">
					<input class="form-control js_blog-title" name="title" placeholder=" ">
					<label class="form-label">{__("Title")}</label>
				</div>
				...
				<div class="form-floating">
					<textarea name="text" class="form-control js_wysiwyg" id="blog-editor" placeholder=" "></textarea>
				</div>
