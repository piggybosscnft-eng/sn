					...
					<div class="ratio ratio-16x9">
						{if $movie['source_type'] == "youtube"}
							{if $system['smart_yt_player']}
								<div>
									<div class="youtube-player js_youtube-player rounded-0" data-id="{get_youtube_id($movie['source'], false)}">
										<img class="position-absolute w-100 h-100 m-auto d-block pointer" src="https://i.ytimg.com/vi/{get_youtube_id($movie['source'], false)}/hqdefault.jpg">
